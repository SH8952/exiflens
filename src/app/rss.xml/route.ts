 ...
 * revisit cadence — see the RSS discussion in
...
<rss version="2.0">
  <channel>
    <title>ExifLens Guides</title>
    <link>${SITE_URL}</link>
    <description>ExifLens EXIF &amp; ND filter guides — new and updated articles across all languages.</description>
